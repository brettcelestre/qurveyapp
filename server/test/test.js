...
describe("server", function() {
  ...
  //       }
  //     });
  //     Question.findOneAndRemove({question: 'test question'}, function(err, question) {
  //       if (err) {
  //         console.error(err);
  //       } else {
  ...
  //   xit("should return newAnswer object", function(done) {
  ...
  //         res.body.question = questionId;
  //         res.body.user = userId;
  //       })
  //       .expect(201, done);
  //   });

  //   xit("should increment response counter of question", function(done) {
  //     var count = 0;
  //     //get question
